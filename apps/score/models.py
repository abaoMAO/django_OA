...
class AnswerSheet(models.Model):
    ...
    questionnaire = models.ForeignKey('Questionnaire', related_name='questionnaire_level_answerSheet',
    ...
    is_active = models.BooleanField(default=True)
    total_score = models.CharField(max_length=5, verbose_name="总得分", null=True, blank=True, default="")
...
class Answer(models.Model):
    answer_sheet = models.ForeignKey('AnswerSheet', related_name='answerSheet_level_answer',
                                     on_delete=models.CASCADE, verbose_name="对应答卷")
    question = models.ForeignKey('Question', related_name='question_level_answer',
                                 on_delete=models.CASCADE, verbose_name="问题")
